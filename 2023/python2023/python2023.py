...
def latest():
    ...
    # print("2023 Day 08 Part 1 (small):", end=" ")
    # print(Day08.part1("../inputs/08/input_small2.txt"))

    # print("2023 Day 08 Part 1:", end=" ")
    # print(Day08.part1("../inputs/08/input.txt"))

    print("2023 Day 08 Part 2 (small):", end=" ")
    print(Day08.part2("../inputs/08/input_small3.txt"))

    print("2023 Day 08 Part 2:", end=" ")
