...
Part 1 was a straightforward simulation problem. We're given some objects,
some rules how they interact, and we're asked to simulate 1000 steps of the
system.

Part 2 had a trick: We needed to determine when the initial state repeated,
but it could be billions, or even trillions of steps of the simulation before
it actually occured. How could you determine when it happens without letting
the simulation play out for days?

I figured out the trick for this on my own, but it slowed me down. I was the
221st person to solve part 1, but dropped down to rank 449 for part 2. Not
spoiling the trick here; take a look at my solution if you wish.

## Solutions

- [Python](./python_day12/day12.py) [(test)](./python_day12/day12_test.py)

## Problem Description

[2019 Day 12 on AdventOfCode.com](https://adventofcode.com/2019/day/12)
