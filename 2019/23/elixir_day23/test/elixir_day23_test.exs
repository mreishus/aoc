defmodule ElixirDay23Test do
  ...
  test "day13_part1" do
    got =
      ElixirDay23.parse("../../13/input.txt")
      |> Breakout.part1()
  ...
  test "day11_part1" do
    got =
      ElixirDay23.parse("../../11/input.txt")
      |> PainterRobot.new(0)
  ...
  test "day9_part1" do
    outputs =
      ElixirDay23.parse("../../09/input.txt")
      |> Computer.solve([1])
  ...
  test "day7_part1" do
    {got_seq, got_val} =
      ElixirDay23.parse("../../07/input.txt")
      |> ElixirDay23.Amplify.amplify_once_max_seq()
  ...
  test "day7_part2" do
    {got_seq, got_val} =
      ElixirDay23.parse("../../07/input.txt")
      |> ElixirDay23.Amplify.amplify_loop_max_seq()
  ...
  test "amplify_once" do
    ...
    |> Enum.each(fn {prog, phase_seq, want_val} ->
      got_val = ElixirDay23.Amplify.amplify_once(prog, phase_seq)
    ...
    |> Enum.each(fn {prog, want_seq, want_val} ->
      {got_seq, got_val} = ElixirDay23.Amplify.amplify_once_max_seq(prog)
  ...
  test "amplify_loop" do
    ...
    test_cases
    |> Enum.each(fn {prog, phase_seq, want_val} ->
      got_val = ElixirDay23.Amplify.amplify_loop(prog, phase_seq)
      assert got_val == want_val
    end)
    ...
    test_cases
    |> Enum.each(fn {prog, want_seq, want_val} ->
      {got_seq, got_val} = ElixirDay23.Amplify.amplify_loop_max_seq(prog)
      assert got_seq == want_seq
      assert got_val == want_val
    end)
  end
  ...
  test "day 5 part1 GenServer (Full Input)" do
    program = ElixirDay23.parse("../../05/input.txt")
  ...
  test "day 5 part1" do
    got =
      ElixirDay23.parse("../../05/input.txt")
      |> Computer.solve([1])
