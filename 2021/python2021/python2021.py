...
def latest():
    ...
    print("2021 Day 20 Part 1 (small):", end=" ")
    print(Day20.part1("../inputs/20/input_small.txt"))
    print("2021 Day 20 Part 2 (small):", end=" ")
    ...
    # print(Day20.part2("../inputs/20/input_small2.txt"))
    # print("")
    # print("--")
    # print("")

    print("2021 Day 20 Part 1:", end=" ")
    print(Day20.part1("../inputs/20/input.txt"))
    print("2021 Day 20 Part 2:", end=" ")
