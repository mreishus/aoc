...
def latest():
    ...
    print("2021 Day 13 Part 1 (small):", end=" ")
    print(Day13.part1("../inputs/13/input_small.txt"))
    print("2021 Day 13 Part 2 (small):", end=" ")
    print(Day13.part2("../inputs/13/input_small.txt"))
    print("")
    print("--")
    print("")
    # print("2021 Day 13 Part 1 (small):", end=" ")
    # print(Day13.part1("../inputs/13/input_small2.txt"))
    # print("2021 Day 13 Part 2 (small):", end=" ")
    # print(Day13.part2("../inputs/13/input_small2.txt"))
    # print("")
    # print("--")
    # print("")

    print("2021 Day 13 Part 1:", end=" ")
    print(Day13.part1("../inputs/13/input.txt"))
    print("2021 Day 13 Part 2:", end=" ")
