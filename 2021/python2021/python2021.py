#!/usr/bin/env python
"""
Main program runner for Advent of Code 2021 in Python.
...
def alldays():
    ...
    for (i, (p1, p2)) in enumerate(solvers, 1):
        ...
        print(f"2021 Day {i:02} Part 1: {p1_answer:15} [{p1_time:7.1f}ms]")
        print(f"2021 Day {i:02} Part 2: {p2_answer:15} [{p2_time:7.1f}ms]")
        if i % 5 == 0:
            print("")
...
def latest():
    ...
    print("2021 Day 18 Part 1 (small):", end=" ")
    print(Day18.part1("../inputs/18/input_small.txt"))
    print("2021 Day 18 Part 2 (small):", end=" ")
    print(Day18.part2("../inputs/18/input_small.txt"))
    print("")
    print("--")
    print("")
    # print("2021 Day 18 Part 1 (small):", end=" ")
    # print(Day18.part1("../inputs/18/input_small2.txt"))
    # print("2021 Day 18 Part 2 (small):", end=" ")
    # print(Day18.part2("../inputs/18/input_small2.txt"))
    # print("")
    # print("--")
    # print("")

    print("2021 Day 18 Part 1:", end=" ")
    print(Day18.part1("../inputs/18/input.txt"))
    print("2021 Day 18 Part 2:", end=" ")
