...
def latest():
    ...
    print("2021 Day 14 Part 1 (small):", end=" ")
    print(Day14.part1("../inputs/14/input_small.txt"))
    print("2021 Day 14 Part 2 (small):", end=" ")
    print(Day14.part2("../inputs/14/input_small.txt"))
    print("")
    print("--")
    print("")
    # print("2021 Day 14 Part 1 (small):", end=" ")
    # print(Day14.part1("../inputs/14/input_small2.txt"))
    # print("2021 Day 14 Part 2 (small):", end=" ")
    # print(Day14.part2("../inputs/14/input_small2.txt"))
    # print("")
    # print("--")
    # print("")

    print("2021 Day 14 Part 1:", end=" ")
    print(Day14.part1("../inputs/14/input.txt"))
    print("2021 Day 14 Part 2:", end=" ")
