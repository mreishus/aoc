...
def latest():
    ...
    print("2021 Day 11 Part 1 (small):", end=" ")
    print(Day11.part1("../inputs/11/input_small.txt"))
    print("2021 Day 11 Part 2 (small):", end=" ")
    print(Day11.part2("../inputs/11/input_small.txt"))
    print("")
    print("--")
    print("")
    # print("2021 Day 11 Part 1 (small):", end=" ")
    # print(Day11.part1("../inputs/11/input_small2.txt"))
    # print("2021 Day 11 Part 2 (small):", end=" ")
    # print(Day11.part2("../inputs/11/input_small2.txt"))
    # print("")
    # print("--")
    # print("")

    print("2021 Day 11 Part 1:", end=" ")
    print(Day11.part1("../inputs/11/input.txt"))
    print("2021 Day 11 Part 2:", end=" ")
