...
def latest():
    ...
    print("2021 Day 15 Part 1 (small):", end=" ")
    print(Day15.part1("../inputs/15/input_small.txt"))
    print("2021 Day 15 Part 2 (small):", end=" ")
    print(Day15.part2("../inputs/15/input_small.txt"))
    print("")
    print("--")
    print("")
    # print("2021 Day 15 Part 1 (small):", end=" ")
    # print(Day15.part1("../inputs/15/input_small2.txt"))
    # print("2021 Day 15 Part 2 (small):", end=" ")
    # print(Day15.part2("../inputs/15/input_small2.txt"))
    # print("")
    # print("--")
    # print("")

    print("2021 Day 15 Part 1:", end=" ")
    print(Day15.part1("../inputs/15/input.txt"))
    print("2021 Day 15 Part 2:", end=" ")
