...
def latest():
    ...
    print("2021 Day 17 Part 1 (small):", end=" ")
    print(Day17.part1("../inputs/17/input_small.txt"))
    print("2021 Day 17 Part 2 (small):", end=" ")
    print(Day17.part2("../inputs/17/input_small.txt"))
    print("")
    print("--")
    print("")
    # print("2021 Day 17 Part 1 (small):", end=" ")
    # print(Day17.part1("../inputs/17/input_small2.txt"))
    # print("2021 Day 17 Part 2 (small):", end=" ")
    # print(Day17.part2("../inputs/17/input_small2.txt"))
    # print("")
    # print("--")
    # print("")

    print("2021 Day 17 Part 1:", end=" ")
    print(Day17.part1("../inputs/17/input.txt"))
    print("2021 Day 17 Part 2:", end=" ")
