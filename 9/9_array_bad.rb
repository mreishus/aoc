...
while 1
  ...
  if marble_to_insert % 23 == 0
    ...
    index_to_delete = (selected_marble_index - 7 + marbles.length) % marbles.length
    ...
    if marbles.length == 1 || marbles.length == 2
      ...
      selected_marble_index = (selected_marble_index + 2 + marbles.length) % marbles.length
      if selected_marble_index == 0
        selected_marble_index = marbles.length
      end
    end
