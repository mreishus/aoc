...
def latest():
    ...
    print("2024 Day 25 Part 1 (small):", end=" ")
    print(Day25.part1("../inputs/25/input_small.txt"))
    #
    print("2024 Day 25 Part 1:", end=" ")
    print(Day25.part1("../inputs/25/input.txt"))

    # print("2024 Day 25 Part 2 (small):", end=" ")
    # print(Day25.part2("../inputs/25/input_small.txt"))

    # print("2024 Day 25 Part 2:", end=" ")
