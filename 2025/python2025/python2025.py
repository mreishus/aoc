#!/usr/bin/env python
"""
Main program runner for Advent of Code 2025 in Python.
...
def alldays():
    ...
    for i, (p1, p2) in enumerate(solvers, 1):
        ...
        print(f"2025 Day {i:02} Part 1: {p1_answer:15} [{p1_time:7.1f}ms]")
        print(f"2025 Day {i:02} Part 2: {p2_answer:15} [{p2_time:7.1f}ms]")
        if i % 5 == 0:
            print("")
